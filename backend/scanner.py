...
class Scanner:
    ...
    def getFileHash(self,path):
        ...
        try:
            ...
            return "ByteAvenger_PERMISSION_ERROR"
    ...
    def scanFile(self,path):
        ...
        try:
            ...
            if not fileExtension == ".unknown" and fileExtension in self.fileTypes:
                ...
                if hashToChk == "ByteAvenger_PERMISSION_ERROR":
                    return "SKIPPED"
                ...
                if not isArchive and suspScore >= 70:
                    notif_str = "ByteAvenger is taking action against detected malware "+ path
                    from notifypy import Notify
                    notification = Notify()
